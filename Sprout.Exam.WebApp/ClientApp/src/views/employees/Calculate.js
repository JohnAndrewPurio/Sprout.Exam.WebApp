...
const MIN_WORK_DAYS = 0;
const MAX_REGULAR_WORK_DAYS = 22;
const MAX_CONTRACTUAL_WORK_DAYS = 31;
...
export class EmployeeCalculate extends Component {
    ...
    handleNumberInputChange(event) {
        ...
        const max = parseFloat(event.target.max || Number.MAX_SAFE_INTEGER);

        let value = parseFloat(event.target.value || 0);

        // If input type is a number,
            ...
            <div>
                <form>
                    ...
                    <div className="form-row">
                        <div className="form-group col-md-12">
                            <label>
                                Net Income: <b>{this.state.netIncome}</b>
                            </label>
                        </div>
                    </div>
